public class Continents {
 ...
 /* This program prints out a continent and the largest city in that continent, based on the value of the integer.
 Use of switch statement with cases 1, 2, 3, 4, 5, 6, and 7 plus default if none of the cases are met. 
 (Depends on the value of the variable int continents) */
